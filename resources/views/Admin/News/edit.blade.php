...
@section('content')
    <form action="{{ route('admin.newsCategories.update', ['category' => $newsCategory->id]) }}" method="post">
        @method('put')
        @csrf
        ...
        <a href="{{ route('admin.newsCategories.index') }}" class="btn btn-warning" id="btn-batal">Batal</a>
    </form>
@endsection
