                            ...
                            <table id="example1" class="table table-striped table-bordered table-hover text-center"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('asset/photo/' . $item['photo']) }}" alt="Foto" style="width: 100px;"></td>
                                        <td>
                                            <a href="{{ route('admin.news.edit', $item->id) }}" class="btn btn-success btn-sm mr-1"><i class="fa-solid fa-pen"></i> Edit</a>
